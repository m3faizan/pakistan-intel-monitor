...
import { X, TrendingUp, TrendingDown, Calendar, Zap } from 'lucide-react';
import {
  AreaChart, Area,
  BarChart, Bar, Cell,
...
const PowerGenerationModal = ({ isOpen, onClose, source, data }) => {
      ...
      <div className="remittances-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-header">
          <div className="modal-title">
            <Zap size={20} />
            <span>{source} — Power Generation</span>
          </div>
          ...
          <ResponsiveContainer width="100%" height={300}>
            {showPctChange ? (
              ...
              <AreaChart data={filteredData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                <defs>
                  <linearGradient id="powerGenAreaGrad" x1="0" y1="0" x2="0" y2="1">
                ...
                <Tooltip content={<CustomTooltip />} />
                <Area type="monotone" dataKey="value" stroke="#22C55E" strokeWidth={2} fillOpacity={1} fill="url(#powerGenAreaGrad)" />
              </AreaChart>
            )}
          </ResponsiveContainer>
        </div>
