    ...
    return (
      <div className="panel" data-testid="power-price-panel" style={{ gridColumn: 'span 2' }}>
        <div className="panel-header">
          <div className="panel-title"><Coins size={16} />Power Price</div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.5rem' }}>
            ...
            >
               <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                   ...
                   <ExternalLink size={10} color="#22c55e" style={{ opacity: 0.5 }} />
               </div>
...
export default PowerPricePanel;
